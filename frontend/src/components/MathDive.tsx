...
const FLOORS: Floor[] = [
  {
    ...
    body: "The most basic calculation you should do, EV is the expected value of buying a card of a suit at any given time.",
    draw: drawEV,
  },
  {
    id: 'bayes',
    ...
    body: 'The order book is your insight into the deeper game. Which suits does your opponent lift? Which prices do they defend? Each observation narrows your uncertainty about the goal suit, and tracking them across the 4 minutes can help understand play styles and tells.',
    draw: drawBayes,
  },
  {
    id: 'queue',
    ...
    body: 'In the advanced game mode, orders survive each trade so long term ordr placement bcomes much more relevant. Playing the spread and maker-taker dynamics will tend to reward patience and punish impatience.',
    draw: drawBook,
  },
  {
    id: 'cta',
    eyebrow: 'Layer 04 — Enter the Market',
    headline: 'Just start playing.',
    equation: 'E[skill] → ∞ as rounds → ∞',
    body: 'The only way to build an edge is to sit at the table and practice. Join a lobby, watch the order flow, and start making markets.',
    draw: drawCTA,
    ctaHref: '/auth',
    ctaLabel: 'Play now',
  },
