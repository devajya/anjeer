...
const HERO_CONTENT = {
  eyebrow: "Math disguised as Multiplayer card trading",
  headline: "Anjeer",
...
function CornerBrackets() {
  return (
    <>
      <svg
        className="ep-corner ep-corner--tl"
        width="12"
        height="12"
        viewBox="0 0 12 12"
        fill="none"
      ...
      <svg
        className="ep-corner ep-corner--tr"
        width="12"
        height="12"
        viewBox="0 0 12 12"
        fill="none"
      ...
      <svg
        className="ep-corner ep-corner--bl"
        width="12"
        height="12"
        viewBox="0 0 12 12"
        fill="none"
      ...
      <svg
        className="ep-corner ep-corner--br"
        width="12"
        height="12"
        viewBox="0 0 12 12"
        fill="none"
...
export function ExpandingPortal({
  reducedMotion,
  isMobile,
}: ExpandingPortalProps) {
    ...
    const draw = () => {
      ...
      for (let gx = SPACING / 2; gx < w + SPACING; gx += SPACING) {
        for (let gy = SPACING / 2; gy < h + SPACING; gy += SPACING) {
          const t = animated
            ? Math.max(0, 1 - Math.hypot(gx - mx, gy - my) / GLOW_R)
            : 0;
            ...
            {!isExpanded && (
              <>
                <div className="ep-suits-preview" aria-hidden="true">
                  <span className="ep-suit-preview-symbol ep-suit--spade">
                    ♠
                  </span>
                  <span className="ep-suit-preview-symbol ep-suit--club">
                    ♣
                  </span>
                  <span className="ep-suit-preview-symbol ep-suit--heart">
                    ♥
                  </span>
                  <span className="ep-suit-preview-symbol ep-suit--diamond">
                    ♦
                  </span>
                </div>
              ...
              <>
                ...
                <canvas
                  ...
                  style={
                    applyParallax
                      ? {
                          transform: `translate(${normX * 6}px, ${normY * 6}px)`,
                        }
                      : undefined
                  }
                />
                ...
                <div
                  ...
                  style={
                    applyParallax
                      ? {
                          transform: `translate(${normX * 18}px, ${normY * 18}px)`,
                        }
                      : undefined
                  }
                >
                  <span
                    className="ep-suit-large ep-suit-large--0"
                    aria-hidden="true"
                  >
                    ♠
                  </span>
                  <span
                    className="ep-suit-large ep-suit-large--1"
                    aria-hidden="true"
                  >
                    ♦
                  </span>
                  <span
                    className="ep-suit-large ep-suit-large--2"
                    aria-hidden="true"
                  >
                    ♥
                  </span>
                  <span
                    className="ep-suit-large ep-suit-large--3"
                    aria-hidden="true"
                  >
                    ♣
                  </span>
                ...
                <div
                  ...
                  style={
                    applyParallax
                      ? {
                          transform: `translate(${normX * 32}px, ${normY * 32}px)`,
                        }
                      : undefined
                  }
                >
